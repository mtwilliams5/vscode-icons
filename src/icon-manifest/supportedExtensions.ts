...
export const extensions: IFileCollection = {
  ...
  supported: [
    ...
    { icon: 'ng_interceptor_ts', extensions: ['interceptor.ts'], version: '4.3.0', format: FileFormat.svg, disabled: true },
    { icon: 'ng_interceptor_js', extensions: ['interceptor.js'], version: '4.3.0', format: FileFormat.svg, disabled: true },
